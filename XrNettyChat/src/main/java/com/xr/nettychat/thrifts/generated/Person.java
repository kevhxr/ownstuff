 ...
 *  @generated
 */
package com.xr.nettychat.thrifts.generated;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.13.0)", date = "2020-06-25")
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField UESRNAME_FIELD_DESC = new org.apache.thrift.protocol.TField("uesrname", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String uesrname; // optional
  public int age; // optional
  public boolean married; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    UESRNAME((short)1, "uesrname"),
    AGE((short)2, "age"),
  ...
  private static final _Fields optionals[] = {_Fields.UESRNAME,_Fields.AGE,_Fields.MARRIED};
  public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.UESRNAME, new org.apache.thrift.meta_data.FieldMetaData("uesrname", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public Person(Person other) {
    ...
    if (other.isSetUesrname()) {
      this.uesrname = other.uesrname;
    }
    this.age = other.age;
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getUesrname() {
    return this.uesrname;
  }

  public Person setUesrname(@org.apache.thrift.annotation.Nullable java.lang.String uesrname) {
    this.uesrname = uesrname;
    return this;
  }

  public void unsetUesrname() {
    this.uesrname = null;
  }

  /** Returns true if field uesrname is set (has been assigned a value) and false otherwise */
  public boolean isSetUesrname() {
    return this.uesrname != null;
  }

  public void setUesrnameIsSet(boolean value) {
    if (!value) {
      this.uesrname = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case UESRNAME:
      if (value == null) {
        ...
        setUesrname((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_uesrname = true && this.isSetUesrname();
    boolean that_present_uesrname = true && that.isSetUesrname();
    if (this_present_uesrname || that_present_uesrname) {
      if (!(this_present_uesrname && that_present_uesrname))
        return false;
      if (!this.uesrname.equals(that.uesrname))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetUesrname()) ? 131071 : 524287);
    if (isSetUesrname())
      hashCode = hashCode * 8191 + uesrname.hashCode();
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetUesrname()).compareTo(other.isSetUesrname());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUesrname()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.uesrname, other.uesrname);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PersonStandardScheme extends org.apache.thrift.scheme.StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          case 1: // UESRNAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.uesrname = iprot.readString();
              struct.setUesrnameIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.uesrname != null) {
        if (struct.isSetUesrname()) {
          oprot.writeFieldBegin(UESRNAME_FIELD_DESC);
          oprot.writeString(struct.uesrname);
          oprot.writeFieldEnd();
        }
      }
      if (struct.isSetAge()) {
